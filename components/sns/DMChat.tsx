  ...
  return (
    ...
    >
      <div className="w-full max-w-[430px] h-full relative bg-black flex flex-col">
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 space-y-4" data-tutorial="dm-list">
          {/* Context/intro */}
        ...
        {/* Input - 하단 고정 */}
        <div className="sticky bottom-0 z-10 px-4 py-3 border-t border-white/10 bg-black" data-tutorial="dm-chat-input">
          <div className="flex items-center gap-3">
