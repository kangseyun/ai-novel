...
import { Loader2, Shield, Home, Users, Settings, LogOut, Megaphone, Brain, Sparkles, BookOpen, Zap, CreditCard, DollarSign, ShieldAlert, FileText, Star, Calendar, TrendingUp, Heart, LineChart, ClipboardCheck, FlaskConical } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/llm-usage', icon: DollarSign, label: 'LLM 비용' },
  ...
  { href: '/admin/influencers', icon: Heart, label: '인플루언서' },
  { href: '/admin/retention', icon: LineChart, label: '리텐션' },
  { href: '/admin/experiments', icon: FlaskConical, label: 'A/B 실험' },
];
